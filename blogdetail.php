...
<div class="wrapper" >
    ...
    <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-widget">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <img class="img-fluid pad"  src="admin/images/<?= $result['0']['image']?>" style="width: 100%;height: 500px;">
  ...
  <!-- /.content-wrapper -->
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="#">Htet Arkar Linn</a>.</strong> All rights reserved.
  </footer>
